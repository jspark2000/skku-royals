...
!(function () {
  ...
  const bc = Io,
    ...
    _c = (e, t) => {
      if (Jd(e)) {
        if (wc(t.previousSibling) && !vc(t.previousSibling)) return ai.before(t)
  ...
  const tu = (e) => '' !== e && -1 !== ' \f\n\r\t\v'.indexOf(e),
    ...
    Ju = (e, t, n, o) => {
      ...
      if ((Fu(l) && (s = l.wrapper ? null : a.getParent(n, l.block, i)), !s)) {
        ...
        s = a.getParent(Ro(n) ? n.parentNode : n, (t) => t !== i && qu(e, t), t)
      }
      if (
    ...
    Vm = (e, t, n, o, r) => {
      ...
      for (; (d = u[o ? 'prev' : 'next']()); ) {
        ...
        if (Ro(d) && d.data.length > 0)
          return jm(d, s, 'A') ? M.none() : M.some(ai(d, o ? d.data.length : 0))
  ...
  const ef = (e) => 'textarea' === Lt(e),
    ...
    Nf = (e) =>
      (e.bookmark ? e.bookmark : M.none())
        .bind((t) => {
          return (n = mn(e.getBody())), (o = t), M.from(o).filter(kf(n)).map(wf)
          var n, o
        })
        .bind(_f),
    Rf = {
  ...
  const dg = ['font', 'text-decoration', 'text-emphasis'],
    ...
    Hp = (e) => {
      ...
      Fo(n.dom) && ss(n)
        ...
        t.length > 1 && H(t, (e) => bn(e, n)) && Vt(n, 'data-mce-selected', '1')
    },
    $p = (e, t, n) =>
      M.some(() => {
          ...
          r = n
            .bind(({ rng: n, isStartInTable: r }) => {
              ...
              n.deleteContents(),
                ((e, t, n) => {
                  n.each((n) => {
                    t ? to(n) : (kr(n), e.selection.setCursorLocation(n.dom, 0))
                  })
                })(e, r, s.filter(ss))
          ...
          ((e, t, n, o) => {
            ...
            Pt(
              ((e, t) => {
                ...
                return Xp(t, n) || Tc(t, e.getBody(), n).exists((e) => Xp(t, e))
              })(e, t),
              S
            )
          ),
                ...
                Ch(t)
                  ...
                  : ((e, t, n, o) => {
                      ...
                      }
                      {
                        ...
                        return wh(e, r, o.no_selection), { content: r, html: r }
                      }
                    })(e, o, t, n)
              )
              ...
              if (((n = Tt.trim(n)), o && -1 === Tt.inArray(t, n))) {
                ...
                try {
                  ...
                  ;((e, t, n) => {
                    ...
                    um(e, 'PluginLoadError', { message: o }), fC(o, n), cC(e, o)
                  })(e, n, t)
                }
              }
            })(e, t, ((e) => e.replace(/^\-/, ''))(n))
