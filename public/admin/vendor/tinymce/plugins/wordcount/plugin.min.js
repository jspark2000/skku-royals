...
!(function () {
      ...
      return ((t, e, n, o) => {
        ...
        for (let u = 0; u < n.length; ++u)
          if ((c.push(t[u]), f(n, u))) {
            const n = e[u]
            if (
              (o.includeWhitespace || !W.test(n)) &&
              (o.includePunctuation || !x.test(n))
            ) {
              ...
              if (E(s)) {
                const n = R(e, u),
                  r = t.slice(o, n)
                Array.prototype.push.apply(c, r), (u = n)
              }
              r.push(c)
            }
            c = []
  ...
  const v = (t, e) => {
    ...
    F = (t) => t.replace(/[\uD800-\uDBFF][\uDC00-\uDFFF]/g, '_').length,
    T = (t, e) => {
      const o = ((t) => t.replace(/\u200B/g, ''))(v(t, e).join('\n'))
    ...
    B = (t, e) => {
      const n = v(t, e).join('').replace(/\s/g, '')
      return F(n)
    },
    D = (t, e) => () => e(t.getBody(), t.schema),
    j = (t, e) => () => e(t.selection.getRng().cloneContents(), t.schema),
    k = (t) => D(t, T)
