...
!(function () {
  ...
  const e = (t, e, r) => {
      const s = 'UL' === e ? 'InsertUnorderedList' : 'InsertOrderedList'
      t.execCommand(s, !1, !1 === r ? null : { 'list-style-type': r })
    },
    r = (t) => (e) => e.options.get(t),
  ...
  const u = (t) => i(t) && /^(TH|TD)$/.test(t.nodeName),
    d = (t) => (l(t) || 'default' === t ? '' : t),
    g = (t, e) => (r) => {
      const s = (s) => {
        r.setActive(
              ...
              l = o.grep(
                ...
                (
                  (t) => (e) =>
                    ...
                    ((t, e) => t.dom.isChildOf(e, t.getBody()))(t, e)
                )(t)
              )
          ...
          r.setEnabled(
            !((t, e) => {
              ...
              return ((t, e) =>
                null !== e && 'false' === t.dom.getContentEditableParent(e))(
                t,
                r
              )
            })(t, s.element)
      ...
      return t.on('NodeChange', s), () => t.off('NodeChange', s)
    },
    h = (t, r, s, n, l, i) => {
      i.length > 1
        ? ((t, r, s, n, l, i) => {
            t.ui.registry.addSplitButton(r, {
                  ...
                  o.map(i, (t) => {
                    const e = 'OL' === l ? 'num' : 'bull',
                      ...
                      n = ((t) =>
                        t
                          .replace(/\-/g, ' ')
                          .replace(/\b\w/g, (t) => t.toUpperCase()))(t)
                    return {
                      type: 'choiceitem',
                      value: s,
                      icon: 'list-' + e + '-' + r,
              ...
              select: (e) => {
                ...
                return r.map((t) => e === t).getOr(!1)
              },
              onSetup: g(t, l)
            })
          })(t, r, s, n, l, i)
        : ((t, r, s, n, l, i) => {
            t.ui.registry.addToggleButton(r, {
              active: !1,
              tooltip: s,
              icon: 'OL' === l ? 'ordered-list' : 'unordered-list',
              onSetup: g(t, l),
              onAction: () =>
                t.queryCommandState(n) || '' === i
                  ? t.execCommand(n)
                  : e(t, l, i)
            })
          })(t, r, s, n, l, d(i[0]))
  ...
  t.add('advlist', (t) => {
    t.hasPlugin('lists')
      ? (((t) => {
        ...
        ((t) => {
          h(t, 'numlist', 'Numbered list', 'InsertOrderedList', 'OL', s(t)),
            h(t, 'bullist', 'Bullet list', 'InsertUnorderedList', 'UL', n(t))
        })(t),
        ((t) => {
          t.addCommand('ApplyUnorderedListStyle', (r, s) => {
            e(t, 'UL', s['list-style-type'])
          }),
            t.addCommand('ApplyOrderedListStyle', (r, s) => {
