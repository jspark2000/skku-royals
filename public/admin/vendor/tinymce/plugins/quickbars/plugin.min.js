...
!(function () {
          ...
          ;((e) =>
            new Promise((t) => {
              ...
              const n = (r) => {
                ...
                u.os.isAndroid() && 'remove' !== r.type
                  ? d.setEditorTimeout(e, i, 0)
                  : i(),
                  e.off('focusin remove', n)
              }
            ...
            if (t.length > 0) {
              ...
              ;((e) =>
                ...
                ;((e, t, o) => {
                  const n = e.editorUpload.blobCache,
                    r = n.create(
                      ((e) => {
                  ...
                  n.add(r),
                    e.insertContent(
                      e.dom.createHTML('img', { src: r.blobUri() })
                    )
                })(e, t, o)
              })
            }
  ...
  var v = (e, t, o, n, i) =>
    e(o, n) ? h.some(o) : r(i) && i(o) ? h.none() : t(o, n, i)
  const b = (e) => {
        ...
        e.ui.registry.addContextToolbar('quickblock', {
          predicate: (t) => {
            const o = p(t),
              ...
              r = (t) => t.dom === e.getBody()
            return ((e, t, o) => v((e, t) => f(e, t), k, e, 'table', o))(
              o,
              0,
              r
            ).fold(
              () =>
                ((t, o, r) =>
                  v(
                    ...
                    t,
                    (t) =>
                      t.dom.nodeName.toLowerCase() in n && e.dom.isEmpty(t.dom),
                    r
                  ))(o, 0, r).isSome(),
              g
            )
      ...
      const t = e.options.register,
        r = (e) => (t) => {
          ...
          return r
            ? n(t)
              ? { value: t ? e : '', valid: r }
              : { value: t.trim(), valid: r }
            : { valid: !1, message: 'Must be a boolean or string.' }
        },
        i = 'bold italic | quicklink h2 h3 blockquote'
      t('quickbars_selection_toolbar', { processor: r(i), default: i })
      const s = 'quickimage quicktable'
      t('quickbars_insert_toolbar', { processor: r(s), default: s })
      const a = 'alignleft aligncenter alignright'
      t('quickbars_image_toolbar', { processor: r(a), default: a })
    })(e),
      m(e),
      w(e),
      ((e) => {
        ...
        n.length > 0 &&
          e.ui.registry.addContextToolbar('textselection', {
            predicate: (o) =>
              ...
              ((t) => 'false' !== e.dom.getContentEditableParent(t))(o),
            items: n,
            position: 'selection',
            scope: 'editor'
          })
