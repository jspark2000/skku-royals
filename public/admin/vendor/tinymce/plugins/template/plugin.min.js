  ...
  const c = (e) => (t) => t.options.get(e),
    ...
    M = (e, t, a = new Date()) => {
      ...
      return (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t = (t =
        ...
        '%y',
        '' + a.getYear()
      )).replace('%m', b(a.getMonth() + 1, 2))).replace(
        '%d',
        b(a.getDate(), 2)
      )).replace('%H', '' + b(a.getHours(), 2))).replace(
        '%M',
        '' + b(a.getMinutes(), 2)
      )).replace('%S', '' + b(a.getSeconds(), 2))).replace(
        '%I',
        '' + (((a.getHours() + 11) % 12) + 1)
  ...
  const x = Object.hasOwnProperty,
    ...
    w = (e) =>
      e.replace(/["'<>&]/g, (e) => {
        return ((t = S),
        (a = e),
        ((e, t) => x.call(e, t))(t, a) ? T.from(t[a]) : T.none()).getOr(e)
        var t, a
      }),
    C = (e, t, a) =>
      ((a, n) => {
    ...
    D = (e, t, a) => {
      ...
      a = O(a, d(e))
      let s = n.create('div', {}, a)
      const l = n.select('.mceTmpl', s)
      l &&
        l.length > 0 &&
        ((s = n.create('div')), s.appendChild(l[0].cloneNode(!0))),
        o.each(n.select('*', s), (t) => {
          C(n, t, i(e)) && (t.innerHTML = M(e, g(e))),
            C(n, t, u(e)) && (t.innerHTML = M(e, v(e))),
            C(n, t, m(e)) && (t.innerHTML = r)
        }),
        A(e, s),
  ...
  const N = (e, t) => {
    ...
    ;(() => {
      if (!t || 0 === t.length) {
        ...
        return e.notificationManager.open({ text: t, type: 'info' }), T.none()
      }
      return T.from(
        o.map(t, (e, t) => {
          ...
          const s = ((e, t) => {
              ...
              if (-1 === t.indexOf('<html>')) {
                ...
                o.each(e.contentCSS, (t) => {
                  ...
                  r && (n += '<style type="text/css">' + r + '</style>')
                const l = _(e),
                  c = e.dom.encode,
                  i =
