...
!(function () {
  ...
  const m = (t) => (e) => ((t) => t.dom.nodeType)(e) === t,
    ...
    T = ('li', (t) => g(t) && 'li' === t.dom.nodeName.toLowerCase())
  const C = (t, e) => {
      const n = t.selection.getSelectedBlocks()
      n.length > 0 &&
        (u(n, (t) => {
          const n = d(t),
            c = T(n),
          ...
          var f
          ;((f = m),
          ((t) => a.from(t.dom.parentNode).map(d))(f).filter(g)).each((t) => {
            if (
              (S(t) !== e
                ? ((t, e, n) => {
                    ;((t, e, n) => {
    ...
    D = (t, e) => (o) => {
      ...
      return t.on('NodeChange', r), () => t.off('NodeChange', r)
    }
