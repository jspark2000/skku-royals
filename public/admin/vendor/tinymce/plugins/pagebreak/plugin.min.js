...
!(function () {
  ...
  const t = (e) => (a) => a.options.get(e),
    ...
    o = 'mce-pagebreak',
    s = (e) => {
      const t = `<img src="${a.transparentSrc}" class="mce-pagebreak" data-mce-resize="false" data-mce-placeholder />`
      return e ? `<p>${t}</p>` : t
    }
  e.add('pagebreak', (e) => {
    ;((e) => {
      ...
      ((e) => {
        ...
        e.on('BeforeSetContent', (e) => {
          ...
          e.on('PreInit', () => {
            e.serializer.addNodeFilter('img', (r) => {
              let n,
                s,
                c = r.length
              for (; c--; )
                if (
                  ((n = r[c]), (s = n.attr('class')), s && -1 !== s.indexOf(o))
                ) {
                  const r = n.parent
                  if (r && e.schema.getBlockElements()[r.name] && t()) {
                    ;(r.type = 3), (r.value = a), (r.raw = !0), n.remove()
                    continue
                  }
