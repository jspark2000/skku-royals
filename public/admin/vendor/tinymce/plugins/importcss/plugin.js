...
;(function () {
  ...
  const register = (editor) => {
    ...
    const filterProcessor = (value) =>
      isString(value) || isFunction(value) || isObject(value)
  ...
  const getSelectors = (editor, doc, fileFilter) => {
    ...
    const append = (styleSheet, imported) => {
      ...
      if (
        !href ||
        (fileFilter && !fileFilter(href, imported)) ||
