...
!(function () {
    ...
    h =
      ...
      (...t) => {
        ...
        for (let o = 0; o < t.length; o++) {
          const n = t[o]
          for (const t in n) m(n, t) && (e[t] = d(e[t], n[t]))
        }
        return e
      })
  var d
  ...
  var y = tinymce.util.Tools.resolve('tinymce.Resource')
  const f = (t) => (e) => e.options.get(t),
    b = f('emoticons_database'),
    w = f('emoticons_database_url'),
    _ = f('emoticons_database_id'),
    j = f('emoticons_append'),
    C = f('emoticons_images_url'),
    k = 'All',
    A = {
      symbols: 'Symbols',
      people: 'People',
    ...
    L = (t, e) =>
      v(t.title.toLowerCase(), e) ||
      ((t, o) => {
        for (let o = 0, s = t.length; o < s; o++)
          if (((n = t[o]), v(n.toLowerCase(), e))) return !0
        var n
        return !1
      })(t.keywords),
    T = (t, e, o) => {
      ...
      for (
        ...
        o < t.length &&
        ((0 !== e.length && !L(t[o], s)) ||
          (n.push({ value: t[o].char, text: t[o].title, icon: t[o].char }),
          !a(n.length)));
        o++
      );
      return n
    ...
    D = 'pattern',
    E = (t, e) => {
      const n = { pattern: '', results: T(e.listAll(), '', a.some(300)) },
        s = l(k),
        r = ((t, e) => {
          let n = null
          const s = () => {
          ...
          ;((t) => {
            const o = t.getData(),
              n = s.get(),
              r = e.listCategory(n),
              i = T(r, o.pattern, n === k ? a.some(300) : a.none())
            t.setData({ results: i })
          })(t)
        }),
        c = { label: 'Search', type: 'input', name: D },
      ...
      m.focus(D),
        e.hasLoaded() ||
          ...
          e
            .waitForLoad()
            .then(() => {
              m.redial(g()), r.throttle(m), m.focus(D), m.unblock()
            })
            .catch((t) => {
              m.redial({
                title: 'Emojis',
  ...
  t.add('emoticons', (t, e) => {
    ...
    ;((t, e) => {
      t.addCommand('mceEmoticons', () => E(t, e))
    })(t, o),
      ((t) => {
          ...
          t.parser.addAttributeFilter('data-emoticon', (t) => {
            ;((t, e) => {
              for (let e = 0, n = t.length; e < n; e++)
                (o = t[e]).attr('data-mce-resize', 'false'),
                  o.attr('data-mce-placeholder', '1')
              var o
            })(t)
          })
        })
