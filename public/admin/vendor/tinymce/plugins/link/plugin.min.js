...
!(function () {
  ...
  const G = (e) => s(e) && 'a' === e.nodeName.toLowerCase(),
    ...
    ne = (e) => {
      ...
      return (
        ...
        J(
          e.selection.getRng(),
          (e) => 1 === e.nodeType && !G(e) && !V(t, e.nodeName.toLowerCase())
        ).length
      )
    },
    oe = (e) =>
    ...
    re = (e, t, n) => {
      const o = e.selection.getNode(),
        ...
        l = ((e, t) => {
          ...
          return (
            m.from(n.target).isNone() && !1 === A(e) && (n.target = O(e)),
            (n.href = ((e, t) =>
              ('http' !== t && 'https' !== t) || W(e) ? e : t + '://' + e)(
              n.href,
              _(e)
            )),
            n
    ...
    le = (e) => {
      const { class: t, href: n, rel: o, target: r, text: l, title: i } = e
      return ((e, t) => {
        const n = {}
        var o
        return (
    ...
    ae = (e, t, n) => {
      ...
      e.hasPlugin('rtc', !0)
        ? e.execCommand('createlink', !1, le(o))
        : re(e, t, o)
    },
    ie = (e) => {
      e.hasPlugin('rtc', !0)
    ...
    se = (e, t) => {
      ...
      if (o) {
        ...
        r &&
          (null === (n = r.parentNode) || void 0 === n || n.insertBefore(o, r),
          e.dom.remove(r))
      }
    },
    ce = (e, t, n) => {
      ...
      if (r) {
        ...
        null === (o = r.parentNode) || void 0 === o || o.insertBefore(t, r),
          t.appendChild(r)
      }
    },
    ue = (e, t) =>
    ...
    ge = (e, t) => {
      const n = { text: e.text, title: e.title },
        o = (e, o) => {
          const r = ((l = t),
          (a = o),
          'link' === a ? l.link : 'anchor' === a ? l.anchor : m.none()).getOr(
            []
          )
          var l, a
          return ((e, t, n, o) => {
            ...
            ? ((e) => {
                const t =
                  ...
                  x(
                    ...
                    m
                      .from(
                        null === (r = o.meta) || void 0 === r ? void 0 : r.text
                      )
                      .getOr(o.value)
                  ))
                var o, r
                const l = ((e) => {
                  ...
                  return x(
                    ...
                    m
                      .from(
                        null === (t = e.meta) || void 0 === t ? void 0 : t.title
                      )
                      .getOr('')
                  )
                })(e.url)
  ...
  var de = tinymce.util.Tools.resolve('tinymce.util.Delay')
  const me = (e) => {
      const t = e.href
      return t.indexOf('@') > 0 &&
        -1 === t.indexOf('/') &&
    ...
    he = (e, t) => (n) => {
      const o = n.href
      return (1 === e && !W(o)) || (0 === e && /^\s*www(\.|\d\.)/i.test(o))
        ? m.some({
    ...
    _e = (e, t) =>
      ((e) => {
        ...
        return new Promise((e) => {
          o(n)
            ? fetch(n)
                .then((e) => (e.ok ? e.text().then(ke) : Promise.reject()))
                .then(e, () => e(m.none()))
            : c(n)
            ? n((t) => e(m.some(t)))
            : e(m.from(n))
          ...
          e
            .bind(j(t))
            .map((e) =>
              e.length > 0 ? [{ text: 'None', value: '' }].concat(e) : e
            )
        )
      })(e).then((n) => {
        const o = ((e, t) => {
          const n = e.dom,
            o = ne(e) ? m.some(ee(e.selection, t)) : m.none(),
            r = t.bind((e) => m.from(n.getAttrib(e, 'href'))),
            l = t.bind((e) => m.from(n.getAttrib(e, 'target'))),
            a = t.bind((e) => be(n, e, 'rel')),
            i = t.bind((e) => be(n, e, 'class'))
          return {
            url: r,
            text: o,
            title: t.bind((e) => be(n, e, 'title')),
            target: l,
            rel: a,
            linkClass: i
          }
    ...
    we = (e) => {
      ...
      t.then((t) => {
        const n = ((e, t) => (n) => {
          const o = n.getData()
          if (!o.url.value) return ie(e), void n.close()
            ...
            body: {
              ...
              items: p([
                ...
                y([
                  ...
                  a.targets.map(K('target', 'Open link in...')),
  ...
  var Ce = tinymce.util.Tools.resolve('tinymce.util.VK')
  const Oe = (e, t) => e.dom.getParent(t, 'a[href]'),
    Ne = (e) => Oe(e, e.selection.getStart()),
    Ae = (e, t) => {
      if (t) {
        const n = Q(t)
        if (/^#/.test(n)) {
    ...
    Ee = (e, t) => (e.on('NodeChange', t), () => e.off('NodeChange', t)),
    Pe = (e) => (t) => {
      const n = () =>
        t.setActive(!e.mode.isReadOnly() && Z(e, e.selection.getNode()))
      return n(), Ee(e, n)
    },
    Re = (e) => (t) => {
      const n = () => t.setEnabled(Z(e, e.selection.getNode()))
      return n(), Ee(e, n)
    },
    Le = (e) => (t) => {
      const n = (t) => {
          return te(t) || ((n = e.selection.getRng()), J(n, H).length > 0)
          var n
        },
        o = e.dom.getParents(e.selection.getStart())
      return t.setEnabled(n(o)), Ee(e, (e) => t.setEnabled(n(e.parents)))
    }
  e.add('link', (e) => {
    ;((e) => {
      ...
      ((e) => {
        e.ui.registry.addContextMenu('link', {
          update: (t) =>
            te(e.dom.getParents(t, 'a')) ? 'link unlink openlink' : 'link'
        })
      })(e),
      ((e) => {
        const t = (t) => {
          ...
          commands: [
            {
              ...
              onSetup: (t) => {
                const n = e.selection.getNode()
                return t.setActive(Z(e, n)), Pe(e)(t)
              },
              onAction: (t) => {
                const n = t.getValue(),
                  o = ((t) => {
      ...
      ((e) => {
        e.on('click', (t) => {
          const n = Oe(e, t.target)
          n && Ce.metaKeyPressed(t) && (t.preventDefault(), Ae(e, n))
        }),
          e.on('keydown', (t) => {
            if (
              ...
              const n = Ne(e)
              n && (t.preventDefault(), Ae(e, n))
            }
          })
      })(e),
      ((e) => {
        e.addCommand('mceLink', (t, n) => {
          !0 !== (null == n ? void 0 : n.dialog) && R(e)
