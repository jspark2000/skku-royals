...
!(function () {
  ...
  const s = 'undefined' != typeof window ? window : Function('return this;')(),
    ...
    u = (e) => (s.Prism && l(e) ? s.Prism : r),
    c = (e) =>
      t(e) && 'PRE' === e.nodeName && -1 !== e.className.indexOf('language-'),
    d = (e) => {
      const t = e.selection ? e.selection.getNode() : null
      return c(t) ? n.some(t) : n.none()
    },
    g = (e) => {
      const t = ((e) =>
          o(e) || [
        ...
        s = ((r = t),
        ((e, t) => (0 < e.length ? n.some(e[0]) : n.none()))(r)).fold(
          ('', () => ''),
          (e) => e.value
        )
      var r
              ...
              return (
                ...
                r.fold(
                  () => {
                    ...
                    const a = s.select('#__new')[0]
                    s.setAttrib(a, 'id', null), e.selection.select(a)
                  },
                  (a) => {
                    s.setAttrib(a, 'class', 'language-' + t),
                      (a.innerHTML = n),
                      u(e).highlightElement(a),
      ...
      ((e) => {
        e.on('PreProcess', (t) => {
          ...
          h.each(h.grep(a, c), (e) => {
            ...
            let a
            for (
              n.setAttrib(e, 'class', p(n.getAttrib(e, 'class'))),
          ...
          e.on('SetContent', () => {
            const t = e.dom,
              n = h.grep(
                t.select('pre'),
                (e) => c(e) && 'true' !== t.getAttrib(e, 'data-mce-highlighted')
              )
            n.length &&
              e.undoManager.transact(() => {
                h.each(n, (n) => {
                  var a
                  h.each(t.select('br', n), (n) => {
                    t.replace(e.getDoc().createTextNode('\n'), n)
                  }),
                    (n.innerHTML = t.encode(
                      null !== (a = n.textContent) && void 0 !== a ? a : ''
                    )),
                    u(e).highlightElement(n),
          ...
          e.on('PreInit', () => {
            e.parser.addNodeFilter('pre', (e) => {
              ...
              for (let n = 0, a = e.length; n < a; n++) {
                const a = e[n]
                ;-1 !==
                  (null !== (t = a.attr('class')) && void 0 !== t
                    ? t
                    : ''
                  ).indexOf('language-') &&
                  (a.attr('contenteditable', 'false'),
                  a.attr('data-mce-highlighted', 'false'))
              }
            })
          })
      })(e),
