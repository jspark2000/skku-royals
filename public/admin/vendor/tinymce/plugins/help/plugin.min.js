...
!(function () {
      ...
      (e) =>
        ...
        ((e) => {
          ...
          return null === e
            ...
            : 'object' === t &&
              ((n = o = e),
              (a = String).prototype.isPrototypeOf(n) ||
                (null === (i = o.constructor) || void 0 === i
                  ? void 0
                  : i.name) === a.name)
            ? 'string'
            : t
  ...
  const f = (e) => {
      const t = v.os.isMacOS() || v.os.isiOS(),
        n = t
          ? {
              alt: '&#x2325;',
              ctrl: '&#x2303;',
      ...
      return t ? a.join('').replace(/\s/, '') : a.join('+')
    },
    w = [
      ...
      items: [
        {
          ...
          cells: p(w, (e) => {
            const t = p(e.shortcuts, f).join(' or ')
            return [e.action, t]
          })
        }
      ]
  ...
  const T = p(
      [
        ...
        { key: 'editimage', name: 'Enhanced Image Editing', type: 'premium' },
      ...
      const t = (e) =>
        ...
        n = (e, n) => {
          ...
          ((e, t, n) => {
            ...
            () =>
              ((e, n) => {
                const o = e.plugins[n].getMetadata
                if (l(o)) {
                  const e = o()
        ...
        o = (e) => {
          const t = ((e) => {
              ...
              return s(n)
                ? t
                : d(t, (e) => !(((e, t) => h.call(e, t))(n, e) > -1))
            })(e),
            o = g(
              p(t, (t) => n(e, t)),
              (e, t) => e.name.localeCompare(t.name)
            ),
            a = p(o, (e) => '<li>' + e.html + '</li>'),
            r = a.length,
            l = a.join('')
          return (
            '<p><b>' +
        ...
        a = {
          ...
          html: [
            ((e) =>
              null == e
                ? ''
                : '<div data-mce-tabstop="1" tabindex="-1">' + o(e) + '</div>')(
              e
            ),
            (() => {
              const e = d(T, ({ type: e }) => 'premium' === e),
                t = g(
                  p(e, (e) => e.name),
                  (e, t) => e.localeCompare(t)
                ),
                n = p(t, (e) => `<li>${e}</li>`).join('')
              return (
                ...
                x.translate('Learn more...') +
                '</a></li></ul></div>'
              )
            })()
          ].join('')
        }
      return { name: 'plugins', title: 'Plugins', items: [a] }
    }
  var C = tinymce.util.Tools.resolve('tinymce.EditorManager')
  const F = (e, t) => () => {
    const { tabs: o, names: i } = ((e, t) => {
        const o = A(),
          i = {
            name: 'keyboardnav',
          ...
          l = (() => {
            ...
            return {
              ...
              items: [
                {
                  type: 'htmlpanel',
                  html: '<p>' + x.translate(['You are using {0}', n]) + '</p>',
                  presets: 'document'
                }
              ]
            }
          })(),
          c = { [o.name]: o, [i.name]: i, [s.name]: s, [l.name]: l, ...t.get() }
        return u.from(a(e)).fold(
          () =>
            ((e) => {
              const t = y(e),
          ...
          (e) =>
            ((e, t) => {
              const o = {},
                a = p(e, (e) => {
                  var a
                  if (r(e)) return k(t, e) && (o[e] = t[e]), e
                  {
                    const t =
                      null !== (a = e.name) && void 0 !== a ? a : n('tab-name')
                    return (o[t] = e), t
                  }
                })
              return { tabs: o, names: a }
            })(e, c)
        )
      })(e, t),
      s = {
        ...
        tabs: ((e) => {
          ...
          p(i, (e) => {
            return k((t = o), (n = e)) ? u.from(t[n]) : u.none()
            var t, n
          })
        )
      }
  ...
  e.add('help', (e) => {
    const t = ((e) => {
      ...
      o = ((e) => ({
        addTab: (t) => {
          var o
          const a = null !== (o = t.name) && void 0 !== o ? o : n('tab-name'),
            i = e.get()
          ;(i[a] = t), e.set(i)
        }
      }))(t)
