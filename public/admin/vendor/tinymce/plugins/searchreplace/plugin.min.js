...
!(function () {
  ...
  const N = (e) => {
    ...
    A = (e, t) => {
      ;((e, t) => {
        const n = ((e) => m.from(e.dom.parentNode).map(T))(e)
        n.each((n) => {
  ...
  const I = (e, t) => e.isBlock(t) || E(e.schema.getVoidElements(), t.nodeName),
    M = (e, t) => 'false' === e.getContentEditable(t),
    R = (e, t) =>
    ...
    V = (e, t) => {
      const n = P(t.startContainer, t.startOffset),
        o = n.element.dom,
    ...
    ne = (t, n) => {
      ...
      o.set(t.windowManager.open(h, { inline: 'toolbar' }))
    },
    oe = (e, t) => () => {
      ne(e, t)
    }
