...
!(function () {
    ...
    n = (t) =>
      ...
      ((t) => {
        ...
        return null === t
          ...
          : 'object' === e &&
            ((n = o = t),
            (s = String).prototype.isPrototypeOf(n) ||
              (null === (r = o.constructor) || void 0 === r
                ? void 0
                : r.name) === s.name)
          ? 'string'
          : e
  ...
  const c = (t) => t.dom.nodeValue,
    d = (t) => 3 === ((t) => t.dom.nodeType)(t),
    h = (t, e, o) => {
      ;((t, e, o) => {
        if (!(n(o) || s(o) || r(o)))
          throw (
    ...
    N = 'mce-nbsp',
    C = (t) =>
      '<span data-mce-bogus="1" class="mce-' + y[t] + '">' + t + '</span>',
    T = (t) => {
      const e = c(t)
      return d(t) && n(e) && w.test(e)
    },
    O = (t, e) => {
      let n = []
      const o = ((t, e) => {
    ...
    S = (t, e) => {
      ...
      i(o, (e) => {
        var o
        const s = e.dom.parentNode
        if (B(s))
          (r = f(s)),
            (a = N),
            v(r)
              ? r.dom.classList.add(a)
              : ((t, e) => {
                  ;((t, e, n) => {
                    const o = m(t, e).concat([n])
                    h(t, e, o.join(' '))
                  })(t, 'class', e)
                })(r, a)
        else {
          const s = n
              .encode(null !== (o = c(e)) && void 0 !== o ? o : '')
              .replace(A, C),
            r = n.create('div', {}, s)
          let a
          for (; (a = r.lastChild); ) n.insertAfter(a, e.dom)
          t.dom.remove(e.dom)
        }
        var r, a
      })
      ...
      i(n, (e) => {
        ...
        B(e)
          ? ((n = f(e)),
            ...
            ((t) => {
              const e = v(t) ? t.dom.classList : ((t) => m(t, 'class'))(t)
