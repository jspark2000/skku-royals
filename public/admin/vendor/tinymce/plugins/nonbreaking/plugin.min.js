...
!(function () {
  ...
  const e = (n) => (e) => typeof e === n,
    ...
    s = (n, e) => {
      let a = ''
      for (let o = 0; o < e; o++) a += n
      return a
    },
    c = (n, e) => {
      const a =
        r(n) || n.plugins.visualchars
          ? `<span class="${
              ((n) =>
                !!n.plugins.visualchars && n.plugins.visualchars.isEnabled())(n)
                ? 'mce-nbsp-wrap mce-nbsp'
                : 'mce-nbsp-wrap'
            }" contenteditable="false">${s('&nbsp;', e)}</span>`
          : s('&nbsp;', e)
      n.undoManager.transact(() => n.insertContent(a))
    }
