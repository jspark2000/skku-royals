...
!(function () {
  ...
  const t = (e) => (t) =>
      ((e) => {
        ...
        return null === e
          ...
          : 'object' === t &&
            ((r = a = e),
            (o = String).prototype.isPrototypeOf(r) ||
              (null === (s = a.constructor) || void 0 === s
                ? void 0
                : s.name) === o.name)
          ? 'string'
          : t
  ...
  const n = Array.prototype.push,
    c = (e, t) => {
      for (let r = 0, a = e.length; r < a; r++) t(e[r], r)
    },
    l = (e) => {
      const t = []
  ...
  const S = O.DOM,
    ...
    T = (e, t) => {
      let r = {}
      for (
        let a = A({ validate: !1, forced_root_block: !1 }, t).parse(e);
        a;
        a = a.walk()
      )
        if (1 === a.type) {
          ...
          r.source || 'param' !== e || (r.source = a.attr('movie')),
            ('iframe' !== e &&
              ...
              'video' !== e &&
              'audio' !== e) ||
              (r.type || (r.type = e), (r = k.extend(a.attributes.map, r))),
            'script' === e && (r = { type: 'script', source: a.attr('src') }),
            'source' === e &&
              (r.source
                ? r.altsource || (r.altsource = a.attr('src'))
                : (r.source = a.attr('src'))),
    ...
    $ = (e) => {
      var t
      const r =
        null !== (t = e.toLowerCase().split('.').pop()) && void 0 !== t ? t : ''
      return d(
        {
          mp3: 'audio/mpeg',
          m4a: 'audio/x-m4a',
  ...
  const F = (e, t = {}) =>
    ...
    B = (e, t) => {
      ...
      if (
        ...
        (k.extend(
          a,
          T(null !== (r = a.embed) && void 0 !== r ? r : '', e.schema)
        ),
        !a.source)
      )
        return ''
      a.altsource || (a.altsource = ''),
        ...
        (a.sourcemime = $(a.source)),
        (a.altsourcemime = $(a.altsource)),
        (a.poster = e.convertURL(a.poster, 'poster'))
      const o = ((e) => {
        const t = L.filter((t) => t.regex.test(e))
        return t.length > 0 ? k.extend({}, t[0], { url: I(t[0], e) }) : null
      })(a.source)
      if (
        (o &&
          ((a.source = o.url),
        ...
        return E(a.embed, a, !0, e.schema)
      {
        ...
        return (
          ...
          'iframe' === a.type
            ...
            : 'application/x-shockwave-flash' === a.sourcemime
            ? ((e) => {
                let t =
                  '<object data="' +
                  e.source +
            ...
            ? ((e, t) =>
                t
                  ...
                  : '<audio controls="controls" src="' +
                    ...
                    '</audio>')(a, t)
            : 'script' === a.type
            ? ((e) => '<script src="' + e.source + '"></script>')(a)
            : ((e, t) =>
                t
                  ? t(e)
                  : '<video width="' +
      ...
      return r
        ? ((e, t, r) =>
            new Promise((a, o) => {
              const s = (r) => (
                r.html && (W[e.source] = r),
                a({ url: e.source, html: r.html ? r.html : t(e) })
              )
              W[e.source] ? s(W[e.source]) : r({ url: e.source }, s, o)
            }))(t, q(e), r)
        : ((e, t) => Promise.resolve({ html: t(e), url: e.source }))(t, q(e))
    },
    J = (e, t) => {
      const r = {}
      return (
      ...
      const r =
        ...
        o = ((e, t, r) => (o) => {
          ...
          return {
            [o]: (o === r
              ? s().bind((e) =>
                  a(e) ? c(e).orThunk(n) : n().orThunk(() => i.from(e))
                )
              : n().orThunk(() => s().bind((e) => (a(e) ? c(e) : i.from(e))))
            ).getOr('')
          }
        })(e, r, t)
      return {
    ...
    X = (e, t) => (a) => {
      if (r(a.url) && a.url.trim().length > 0) {
        const r = a.html,
          o = { ...T(r, t.schema), source: a.url, embed: r }
        e.setData(Q(o))
      }
    },
    Y = (e, t) => {
    ...
    Z = (e) => {
      const t = ((e) => {
          const t = e.selection.getNode(),
            r = G(t) ? e.serializer.serialize(t, { selection: !0 }) : ''
          return { embed: r, ...T(r, e.schema) }
        })(e),
        r = ((e) => {
          let t = e
          return {
        ...
        u = e.windowManager.open({
          ...
          onSubmit: (t) => {
            ...
            ;((e, t, r) => {
              var a, o
              ;(t.embed = E(
                null !== (a = t.embed) && void 0 !== a ? a : '',
                t,
                !1,
                r.schema
              )),
                t.embed && (e.source === t.source || ((o = t.source), h(W, o)))
                  ? Y(r, t.embed)
                  : H(r, t)
                      .then((e) => {
                        Y(r, e.html)
  ...
  const te = (e) => {
    ...
    ae = (e, t, r) => {
      const a = 'img' === t.name || 'video' === e.name,
        ...
        i = a ? s : null
      t.attr({ width: re(e, r, 'width', o), height: re(e, r, 'height', i) })
    },
    oe = (e, t) => {
      const r = t.name,
        a = new z('img', 1)
    ...
    se = (e, t) => {
      ...
      if (
        ...
        n.attr({ allowfullscreen: t.attr('allowfullscreen'), frameborder: '0' })
      else {
        c(
          [
            'controls',
        ...
        s(r) &&
          ((e, t, r, a) => {
            const o = F(e.schema).parse(a, { context: t })
            for (; o.firstChild; ) r.append(o.firstChild)
          })(e, a, n, unescape(r))
      }
      const l = new z('span', 1)
      return l.attr('class', 'mce-shim'), o.append(n), o.append(l), o
    },
    ie = (e, t, r) => {
      var a
      ...
      for (; s--; ) {
        ...
        'width' === t ||
          ...
          'style' === t ||
          ((n = 'data-mce-'),
          (i = t).length >= n.length && i.substr(0, 0 + n.length) === n) ||
          (('data' !== t && 'src' !== t) || (a = e.convertURL(a, t)),
    ...
    ce = (e) => {
      let t = e
      for (; (t = t.parent); )
        if (t.attr('data-ephox-embed-iri') || ne(t)) return !0
      return !1
    },
    le = (e, t, r) => {
      const a = f(e)
      return F(e.schema, { validate: a }).parse(r, { context: t })
    }
  e.add(
    'media',
    (e) => (
      ...
      ((e) => {
        ...
        e.ui.registry.addToggleButton('media', {
          ...
          onSetup: (t) => {
            const r = e.selection
            return (
              t.setActive(G(r.getNode())),
              r.selectorChangedWithUnbind(
      ...
      ((e) => {
        e.on('PreInit', () => {
          const { schema: t, serializer: r, parser: a } = e,
            o = t.getBoolAttrs()
                  ...
                  (r = t[a]),
                    r.parent &&
                      (r.parent.attr('data-mce-object') ||
                        (te(r) && v(e)
                          ? ce(r) || r.replace(se(e, r))
                          : ce(r) || r.replace(oe(e, r))))
              })(e)
            ),
