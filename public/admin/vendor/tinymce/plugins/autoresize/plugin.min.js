...
!(function () {
  ...
  const o = (e) => (t) => t.options.get(e),
    ...
    a = (e, t, o, n) => {
      var s
      const i = parseInt(
        null !== (s = e.getStyle(t, o, n)) && void 0 !== s ? s : '',
        10
      )
      return isNaN(i) ? 0 : i
    },
    g = (e, o, i) => {
      ...
      const f = d.documentElement,
        m = r(e),
        p =
          null !== (c = n(e)) && void 0 !== c ? c : e.getElement().offsetHeight
      let h = p
      const v = a(u, f, 'margin-top', !0),
        y = a(u, f, 'margin-bottom', !0)
      let C = f.offsetHeight + v + y + m
      C < 0 && (C = 0)
      const S =
        e.getContainer().offsetHeight - e.getContentAreaContainer().offsetHeight
      C + S > p && (h = C + S)
      const z = s(e)
      if ((z && h > z ? ((h = z), l(e, !0)) : l(e, !1), h !== o.get())) {
        const n = h - o.get()
        if (
          (u.setStyle(e.getContainer(), 'height', h + 'px'),
          o.set(h),
          ((e) => {
      ...
      ;((e, t) => {
        ...
        ((e, t) => {
          e.on('init', () => {
            const t = i(e),
              o = e.dom
            o.setStyles(e.getDoc().documentElement, { height: 'auto' }),
