...
;(function () {
  ...
  const parseCssValueToInt = (dom, elm, name, computed) => {
    ...
    const value = parseInt(
      (_a = dom.getStyle(elm, name, computed)) !== null && _a !== void 0
        ? _a
        : '',
      10
    )
  ...
  const resize = (editor, oldSize, trigger) => {
    ...
    const minHeight =
      (_a = getMinHeight(editor)) !== null && _a !== void 0
        ? _a
    ...
    if (resizeHeight !== oldSize.get()) {
      ...
      if (
        (global.browser.isSafari() || global.browser.isChromium()) &&
        deltaSize < 0
      ) {
