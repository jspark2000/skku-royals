        ...
        : Ur(e).bind((r) =>
            Ur(t).bind((s) => {
              ...
              if (xe(r, s)) {
                ...
                return C.some({ boxes: jr(r, e, r, t, s), start: e, finish: l })
              }
              if (xe(s, r)) {
                const o = nt(e, 'td,th', n(s)),
                  l = o.length > 0 ? o[o.length - 1] : e
                return C.some({ boxes: jr(s, e, r, t, s), start: e, finish: l })
              }
              return ((e, t, o) =>
                ((e, t, o, n = y) => {
                        ...
                        Ki(s.target, o).each((l) => {
                          Gr(r, l, o).each((o) => {
                            ...
                            if (1 === r.length) {
                              ...
                              l &&
                                a &&
                                (n.selectRange(t, r, o, o), e.selectContents(o))
                            } else
                              r.length > 1 &&
                          ...
                          return s.fold(
                            () =>
                              Yr(
                                ...
                                const o =
                                  Zi(u) || m.isForward(u) ? Fc.after : Fc.before
                                return (
        ...
        e.on('ObjectResizeStart', (t) => {
          ...
          if (sd(o)) {
            ...
            N(e.dom.select('.mce-clonedresizable'), (t) => {
              e.dom.addClass(t, 'mce-' + qa(e) + '-columns')
            }),
