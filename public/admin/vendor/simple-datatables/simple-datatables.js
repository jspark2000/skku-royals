                          ...
                          (this.$d = (function (t, e, n) {
                            try {
                              ...
                              return c
                                ...
                                : n
                                ? new Date(Date.UTC(M, m, $, D, v, p, g))
                                : new Date(M, m, $, D, v, p, g)
                            } catch (t) {
                              return new Date('')
                            }
                          })(e, o, r)),
          ...
          class o {
            ...
            render(t) {
              ...
              if (
                ...
                this.body ||
                  ((this.body = e('tbody')), this.dom.appendChild(this.body)),
              ...
              if (
                ...
                s.header || (this.head && this.dom.removeChild(this.dom.tHead)),
                s.footer
                  ? this.head &&
                    !this.foot &&
                ...
                s.scrollY.length
                  ...
                  : (i += "<div class='dataTable-container'></div>"),
              ...
              a.appendChild(n),
                (i = i.replace(/\{pager\}/g, a.outerHTML)),
            ...
            renderPage() {
              ...
              if (
                (this.totalPages &&
                  ...
                  (i = e * this.options.perPage),
                  (a = i + this.pages[e].length),
                  (i += 1),
                  (t = this.searching
            ...
            renderPager() {
              if ((s(this.pagers), this.totalPages > 1)) {
                ...
                this.options.firstLast &&
                  s.appendChild(i(t, 1, this.options.firstText)),
            ...
            paginate() {
              ...
              return (
                ...
                this.options.paging
                  ? (this.pages = e
                      .map((s, i) => (i % t == 0 ? e.slice(i, i + t) : null))
                      .filter((t) => t))
                  : (this.pages = [e]),
                  ...
                  if (isNaN(o.selection)) {
                    if (Array.isArray(o.selection))
                      for (n = 0; n < o.selection.length; n++)
                        i = i.concat(this.pages[o.selection[n] - 1])
                  } else i = i.concat(this.pages[o.selection - 1])
                  ...
                  if ('txt' === o.type || 'csv' === o.type) {
                    for (h = '', n = 0; n < i.length; n++) {
                      for (r = 0; r < i[n].cells.length; r++)
                        if (
                          !o.skipColumn.includes(s[r].originalCellIndex) &&
                          this.columns(s[r].originalCellIndex).visible()
                        ) {
                          ...
                          ;(t = t.trim()),
                            ...
                            (t = t.replace(/#/g, '%23')),
                            t.includes(',') && (t = `"${t}"`),
                            (h += t + o.columnDelimiter)
                        }
                      ;(h = h.trim().substring(0, h.length - 1)),
                        (h += o.lineDelimiter)
                    }
                    ;(h = h.trim().substring(0, h.length - 1)),
                      o.download && (h = `data:text/csv;charset=utf-8,${h}`)
                  } else if ('sql' === o.type) {
                    for (
                      h = `INSERT INTO \`${o.tableName}\` (`, n = 0;
                      n < s.length;
                      n++
                    )
                      !o.skipColumn.includes(s[n].originalCellIndex) &&
                        this.columns(s[n].originalCellIndex).visible() &&
                        (h += `\`${s[n].textContent}\`,`)
                    for (
                      h = h.trim().substring(0, h.length - 1),
                        h += ') VALUES ',
                      ...
                      for (h += '(', r = 0; r < i[n].cells.length; r++)
                        !o.skipColumn.includes(s[r].originalCellIndex) &&
                          this.columns(s[r].originalCellIndex).visible() &&
                          (h += `"${i[n].cells[r].textContent}",`)
                      ;(h = h.trim().substring(0, h.length - 1)), (h += '),')
                    }
                    ;(h = h.trim().substring(0, h.length - 1)),
                      (h += ';'),
                      o.download &&
                        (h = `data:application/sql;charset=utf-8,${h}`)
                  } else if ('json' === o.type) {
                    ...
                    ;(h = JSON.stringify(a, o.replacer, o.space)),
                      o.download &&
                        (h = `data:application/json;charset=utf-8,${h}`)
                  }
                  return (
                    o.download &&
