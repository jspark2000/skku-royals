;(window.webpackJsonp = window.webpackJsonp || []).push([
  [7],
  {
    ...
    339: function (e, t, a) {
      ...
      var o = {
          name: 'CodeGroup',
          data: () => ({ codeTabs: [], activeCodeTabIndex: -1 }),
          watch: {
            activeCodeTabIndex(e) {
          ...
          methods: {
            ...
            loadTabs() {
              ;(this.codeTabs = (this.$slots.default || [])
                .filter((e) => Boolean(e.componentOptions))
                .map(
                  (e, t) => (
                    '' === e.componentOptions.propsData.active &&
                      (this.activeCodeTabIndex = t),
                    { title: e.componentOptions.propsData.title, elm: e.elm }
                  )
                )),
          ...
          function () {
            ...
            return a('ClientOnly', [
              a(
                ...
                [
                  a('div', { staticClass: 'theme-code-group__nav' }, [
                    a(
                      'ul',
