        ...
        r = Object(n.a)(
          ...
          function () {
            ...
            return s(
              ...
              [
                s('h1', { attrs: { id: 'mixed-chart-types' } }, [
                  s(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#mixed-chart-types' }
                    },
                    [t._v('#')]
                  ),
                  t._v(' Mixed Chart Types')
                ]),
                t._v(' '),
                s('p', [
                  t._v(
                ...
                s('h2', { attrs: { id: 'drawing-order' } }, [
                  s(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#drawing-order' }
                    },
                    [t._v('#')]
                  ),
                  t._v(' Drawing order')
                ...
                s('p', [
                  t._v(
                    'By default, datasets are drawn such that the first one is top-most. This can be altered by specifying '
                  ),
                  s('code', [t._v('order')]),
                  t._v(' option to datasets. '),
                  s('code', [t._v('order')]),
                  t._v(' defaults to '),
                  s('code', [t._v('0')]),
                  t._v(
                    ...
                    [
                      s('code', [
                        ...
                        s(
                          ...
                          [t._v('// this dataset is drawn below')]
                        ),
                        t._v('\n           '),
                        s(
                          'span',
                        ...
                        s(
                          'span',
                          { pre: !0, attrs: { class: 'token comment' } },
                          [t._v('// this dataset is drawn on top')]
                        ),
                        t._v('\n           '),
                        s(
                          'span',
