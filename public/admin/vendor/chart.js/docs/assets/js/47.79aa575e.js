            ...
            return a(
              ...
              [
                a(
                  ...
                  {
                    attrs: {
                      id: 'interface-chartdatasetpropertiescustomtypesperdataset-ttype-tdata'
                    }
                  },
                  [
                    a(
                      'a',
                      {
                        ...
                        attrs: {
                          href: '#interface-chartdatasetpropertiescustomtypesperdataset-ttype-tdata'
                        }
                      },
                      [t._v('#')]
                    ),
                ...
                a('p', [
                  a(
                    ...
                    {
                      attrs: {
                        href: 'https://github.com/chartjs/Chart.js/blob/5ea4b3a/types/index.esm.d.ts#L3656',
                        target: '_blank',
                        rel: 'noopener noreferrer'
                      }
                    },
                    [t._v('index.esm.d.ts:3656'), a('OutboundLink')],
                    1
                  )
                ]),
                t._v(' '),
                ...
                a('p', [
                  a(
                    ...
                    {
                      attrs: {
                        href: 'https://github.com/chartjs/Chart.js/blob/5ea4b3a/types/index.esm.d.ts#L3655',
                        target: '_blank',
                        rel: 'noopener noreferrer'
                      }
                    },
                    [t._v('index.esm.d.ts:3655'), a('OutboundLink')],
                    1
                  )
                ])
              ]
