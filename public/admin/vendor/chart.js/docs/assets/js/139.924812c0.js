        ...
        s = Object(t.a)(
          ...
          function () {
            ...
            return e(
              ...
              [
                e('h1', { attrs: { id: 'radial-axes' } }, [
                  e(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#radial-axes' }
                    },
                    [n._v('#')]
                  ),
                  n._v(' Radial Axes')
                ...
                n._v(' '),
                e('h2', { attrs: { id: 'visual-components' } }, [
                  e(
                    'a',
                    {
                      staticClass: 'header-anchor',
                ...
                e('ul', [
                  e('li', [
                    e('a', { attrs: { href: '#angle-lines' } }, [
                      n._v('angle lines')
                    ])
                  ]),
                  n._v(' '),
                  e('li', [
                    e('a', { attrs: { href: '#grid-lines' } }, [
                      n._v('grid lines')
                    ])
                  ]),
                  n._v(' '),
                  e('li', [
                    e('a', { attrs: { href: '#point-labels' } }, [
                      n._v('point labels')
                    ])
                  ]),
                  n._v(' '),
                  e('li', [
                    e('a', { attrs: { href: '#ticks' } }, [n._v('ticks')])
                  ])
                ]),
                n._v(' '),
                e('h3', { attrs: { id: 'angle-lines' } }, [
                  e(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#angle-lines' }
                    },
                    [n._v('#')]
                  ),
                  n._v(' Angle Lines')
                ...
                e('h3', { attrs: { id: 'point-labels' } }, [
                  e(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#point-labels' }
                    },
                    [n._v('#')]
                  ),
                  n._v(' Point Labels')
