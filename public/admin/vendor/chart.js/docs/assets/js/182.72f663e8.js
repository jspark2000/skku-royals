            ...
            return s(
              ...
              [
                s('h1', { attrs: { id: 'usage' } }, [
                  s(
                    'a',
                    { staticClass: 'header-anchor', attrs: { href: '#usage' } },
                    [t._v('#')]
                  ),
                  t._v(' Usage')
                ]),
                ...
                t._v(' '),
                s('p', [
                  t._v('To create a chart, we need to instantiate the '),
                  s('code', [t._v('Chart')]),
                  t._v(
                    " class. To do this, we need to pass in the node, jQuery instance, or 2d context of the canvas of where we want to draw the chart. Here's an example."
                  )
                ]),
                t._v(' '),
                    ...
                    [
                      s('code', [
                        s(
                          ...
                          [t._v('// Any of the following formats may be used')]
                        ),
                        t._v('\n'),
                        s(
                          'span',
