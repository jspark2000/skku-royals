        ...
        s = Object(o.a)(
          ...
          function () {
            ...
            return a(
              ...
              [
                a('h1', { attrs: { id: 'linear-axis' } }, [
                  a(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#linear-axis' }
                    },
                    [t._v('#')]
                  ),
                  t._v(' Linear Axis')
                ...
                t._v(' '),
                a('h3', { attrs: { id: 'linear-axis-specific-options' } }, [
                  a(
                    'a',
                    {
                      staticClass: 'header-anchor',
                      attrs: { href: '#linear-axis-specific-options' }
                    },
                    [t._v('#')]
                  ),
                  t._v(' Linear Axis specific options')
                ]),
                t._v(' '),
                a('p', [
                  t._v('Namespace: '),
                ...
                a('table', [
                  ...
                  a('tbody', [
                    ...
                    a('tr', [
                      ...
                      t._v(' '),
                      a('td', [
                        t._v('Percentage (string ending with '),
                        a('code', [t._v('%')]),
                        t._v(
                          ') or amount (number) for added room in the scale range above and below data. '
                        ),
                        a('a', { attrs: { href: '#grace' } }, [t._v('more...')])
                      ])
                    ])
                  ])
                ]),
                ...
                a(
                  'h3',
                  { attrs: { id: 'linear-axis-specific-tick-options' } },
                  [
                    a(
                      'a',
                      {
                        staticClass: 'header-anchor',
                        attrs: { href: '#linear-axis-specific-tick-options' }
                      },
                      [t._v('#')]
                    ),
                ...
                a('h2', { attrs: { id: 'grace' } }, [
                  a(
                    'a',
                    { staticClass: 'header-anchor', attrs: { href: '#grace' } },
                    [t._v('#')]
                  ),
                  t._v(' Grace')
                ]),
                t._v(' '),
                a('p', [
                  t._v('If the value is string ending with '),
                  a('code', [t._v('%')]),
                  t._v(
                ...
                t._v(' '),
                a('p', [t._v('Internally, the linear scale uses numeric data')])
              ],
              1
            )
          },
