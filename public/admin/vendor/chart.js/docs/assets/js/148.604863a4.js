            ...
            return a(
              ...
              [
                ...
                a('ul', [
                  ...
                  t._v(' '),
                  a('li', [
                    a('code', [t._v('options.datasets.polarArea')]),
                    t._v(' - options for all polarArea datasets')
                  ]),
                  t._v(' '),
                  a(
                    'li',
                ...
                a('table', [
                  ...
                  a('tbody', [
                    ...
                    a('tr', [
                      ...
                      t._v(' '),
                      a('td', [
                        t._v('By default the Arc is curved. If '),
                        a('code', [t._v('circular: false')]),
                        t._v(' the Arc will be flat.')
                      ])
                    ])
                  ])
                ]),
                ...
                a('p', [
                  t._v(
                    'These are the customisation options specific to Polar Area charts. These options are looked up on access, and form together with the '
                  ),
                  a('a', { attrs: { href: '#default-options' } }, [
                    t._v('global chart default options')
                  ]),
                  t._v(' the options of the chart.')
                ]),
                t._v(' '),
                a('table', [
                  a('thead', [
                ...
                a(
                  'p',
                  [
                    t._v('The polar area chart uses the '),
                    a(
                      'RouterLink',
                    ...
                    t._v(
                      ' scale. Additional configuration is provided via the scale.'
                    )
                  ],
                  1
                ),
                ...
                a('p', [
                  t._v(
                    'We can also change these default values for each PolarArea type that is created, this object is available at '
                  ),
                  a('code', [t._v('Chart.overrides.polarArea')]),
                  t._v(
                ...
                a('p', [
                  t._v(
                    'For example, to configure all new polar area charts with '
                  ),
                  a('code', [t._v('animateScale = false')]),
                  t._v(' you would do:')
                ]),
                t._v(' '),
